...
gfx/2d/crosshair-shotty
{
	noPicMip
	{
		map gfx/2d/crosshair-shotty.tga
		blendfunc blend
		rgbgen const ( 0.0 0.8 1.0 )
		alphagen const 0.35
	}
...
gfx/2d/crosshair-misc
{
	noPicMip
	{
		map gfx/2d/crosshair-misc.tga
		blendfunc blend
		rgbgen const ( 0.8 0.0 0.0 )
		alphagen const 0.35
	}
}
gfx/2d/crosshair-blaster
{
	noPicMip
	{
		map gfx/2d/crosshair-misc.tga
